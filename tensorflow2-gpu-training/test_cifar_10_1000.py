...
model.fit(train_generator, epochs=NUM_EPOCHS, validation_data=validation_generator, validation_freq=1, callbacks=[tensorboard_callback, lr_schedule_callback])
