...
def mnist_datasets():
    ...
    # numpy default float 64, tf default float32
...
# use conv2d, max poling2d and dropout from keras.layers
# build a keras sequential conv model
...
# using a LayersModel over the lower-level API can be saved

optimizer = optimizers.SGD(learning_rate=0.01, momentum=0.5)

# expected to use interget instead of one-hot for labels
# the model output os logits is one-hot
